CREATE OR REPLACE FUNCTION public.create_chat_conversation(
  _type public.conversation_type,
  _name text DEFAULT NULL,
  _description text DEFAULT NULL,
  _is_private boolean DEFAULT true,
...
REVOKE ALL ON FUNCTION public.create_chat_conversation(public.conversation_type, text, text, boolean, uuid[], uuid) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.create_chat_conversation(public.conversation_type, text, text, boolean, uuid[], uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.create_chat_conversation(public.conversation_type, text, text, boolean, uuid[], uuid) TO service_role;