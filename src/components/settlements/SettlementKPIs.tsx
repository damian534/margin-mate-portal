...
import { DollarSign, TrendingUp, BarChart3, Home, Building2, Landmark, ArrowUpRight, ArrowDownRight, Sigma } from 'lucide-react';
...
export function SettlementKPIs({ kpis }: KPIProps) {
  const cards = [
    ...
    { label: 'Projected Total', value: formatCurrency(kpis.totalSettledVolume + kpis.totalPendingVolume), icon: Sigma, sub: 'Settled + Pending' },
