...
export const SAMPLE_REFERRERS = [
  ...
  { id: 'ref-3', user_id: 'preview-user-id', full_name: 'Demo User', email: 'demo@brokerage.com', phone: '0400 000 000', company_name: null, company_id: null, date_of_birth: null, spouse_name: null, interests: null, address: null, license_number: null, custom_fields: {}, broker_notes: null, created_at: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString() },
];
